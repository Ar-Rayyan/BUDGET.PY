class Budget:
    ...
    def create_categories(self):
        number_of_categories = int(input("You can create Food,Entertainment, Clothing...How many do you want to create?: "))
 ...
 [6] - BALANCE.
        """)
        try:
            action = int(input("Which operation do you want to perform? Type 1,2,3,4,5,6: "))
            if action == 1:
                self.deposit_funds()
    ...
    def deposit_funds(self):
        ...
        try:
            ...
            try:
                reply = int(input('Would you like to carry out another operation? Type 1 for "Yes" and 2 for "No" \n'))
                if reply == 1:
                    self.operation()
                elif reply == 2:
    ...
    def withdraw_funds(self):
        print("These categories are available?")
        for category in self.category_list:
            print(self.category_list.index(category) + 1, category)
        try:
